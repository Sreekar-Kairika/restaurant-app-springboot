...
import com.springboot.restaurant.service.CartItemService;
...
class RestaurantApplicationTests {
	...
	Cart cart = new Cart(user, Arrays.asList(cartItem), 50, 2);

	@Test
	void contextLoads() {
		Assertions.assertEquals("Idly", item1.getItemName());
...
//	Items
	...
	void setCartItemCartTest() {
		...
		Assertions.assertEquals(50, cartItem.getCart().getTotal());
	}
	//Cart
	@Test
	void setUserCartTest() {
		user.setCart(cart);
		Assertions.assertEquals(50, user.getCart().getTotal());
	}
	@Test
...
//	Item Entity
	...
	void setTotalTest(){
		cart.setTotal(300);
		Assertions.assertEquals(300, cart.getTotal());
